package cn.edu.user.service;

import cn.edu.user.service.hystrix.UserServiceHystrix;
...
@FeignClient(value = "EDU-USER-SERVICE" , fallback=UserServiceHystrix.class)
public interface UserService {
    ...
    EduResult login(@RequestBody TbUser user);
